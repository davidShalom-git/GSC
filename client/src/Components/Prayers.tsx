...
const Prayers = () => {
    ...
    return (
        <>
            ...
            <div>
                <div className='flex justify-center px-6 md:px-16 lg:px-24 xl:px-32 mt-20 mb-20'>
            ...
            <div className='flex flex-col lg:flex-row items-center justify-between gap-12 px-6 md:px-16 lg:px-24 xl:px-32 min-h-screen bg-linear-to-br from-gray-50 to-gray-500 py-16'>
                ...
                <div className='flex-1 space-y-8'>
                    ...
                    <div className='bg-white p-8 rounded-2xl shadow-lg border border-gray-100'>
                        ...
                        <p className='text-gray-600 text-lg leading-relaxed text-justify'>
                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Harum in eligendi debitis, nemo labore, optio cupiditate nobis hic tempore atque obcaecati dignissimos magni eveniet. Libero error fugiat quisquam natus soluta dignissimos molestias repudiandae alias! Labore maiores rerum perferendis, vel porro repellat vitae quidem architecto provident veniam, in nostrum. Ducimus qui, sequi harum cum iste placeat minus impedit voluptate autem cupiditate quod soluta libero doloremque dignissimos eaque tenetur consequuntur?
                        </p>
            ...
            <div className='flex flex-col lg:flex-row items-center justify-between gap-12 px-6 md:px-16 lg:px-24 xl:px-32 min-h-screen bg-linear-to-br from-gray-50 to-gray-100 py-16'>
