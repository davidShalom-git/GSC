            ...
            <div className="hidden md:flex items-center gap-1">
              {navItems.map((item, index) => (
                <motion.a
                  ...
                  className="group relative px-6 py-2.5 rounded-xl font-medium text-gray-700 hover:text-orange-500 hover:bg-orange-50 transition-all duration-300"
                >
                  <span>{item.name}</span>
                  <div className="absolute bottom-0 left-1/2 -translate-x-1/2 h-0.5 w-0 group-hover:w-3/4 bg-orange-500 transition-all duration-300"></div>
                </motion.a>
              ))}
            </div>
