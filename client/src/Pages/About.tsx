  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="flex items-center justify-between h-20">
      ...
      <div className="hidden md:flex items-center gap-1">
        {navItems.map((item, index) => (
          ...
          >
            <Link
              to={item.path}
              className={`group relative px-6 py-2.5 rounded-xl font-medium transition-all duration-300 flex items-center gap-2 ${
                isScrolled
      ...
      <button
        ...
        className="md:hidden p-2.5 rounded-xl bg-gray-100 text-gray-800 hover:bg-gray-200 transition-all duration-300 z-50"
      >
      ...
      <div className="flex flex-col py-4 space-y-2">
        {navItems.map((item, index) => (
          <Link
            ...
            className="px-6 py-3 text-gray-700 hover:bg-orange-50 hover:text-orange-500 transition-all duration-300 font-medium"
          >
            {item.name}
          </Link>
        ))}
        <button 
          onClick={() => setIsMenuOpen(false)}
          className="mx-6 mt-4 px-6 py-2.5 rounded-xl font-semibold bg-linear-to-r from-orange-500 to-red-500 text-white hover:shadow-lg transition-all duration-300"
        >
          Join Us
        </button>
      </div>
